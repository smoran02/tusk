...
LABEL org.opencontainers.image.title="24-noble-small-tusk"
LABEL org.opencontainers.image.source="https://github.com/mshafae/tusk"
LABEL org.opencontainers.image.description="A development container based on Ubuntu 24 (Noble) with clang/LLVM for Makefile based C++ projects; includes an unprivileged user 'tuffy' with git configured for command line usage. Localized to C.UTF-8 and set in PDT timezone."
